...
def _cached(**overrides):
    base = dict(
        ...
        channel_url="",
        summary_overview=(
            "Первое предложение о главном тезисе ролика. Второе предложение "
            "с важными деталями и контекстом происходящего. Третье предложение "
            "добавляет нюансов к общей картине. Четвёртое предложение уже "
