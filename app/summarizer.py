...
SUMMARY_JSON_PROMPT = """
Сделай summary по транскрипции YouTube-ролика. ВЕСЬ ТЕКСТ ОТВЕТА — НА РУССКОМ ЯЗЫКЕ,
независимо от языка транскрипции (английский, немецкий, etc.) — переводи смысл на русский.
...
Все строковые значения в JSON — РУССКИЙ ТЕКСТ.
Схема:
{{
  "overview": "[ПИШИ НА РУССКОМ] Содержательный обзор. Начни с ГЛАВНОЙ ИДЕИ или КЛЮЧЕВОГО ВЫВОДА ролика одной чёткой формулировкой по сути. Затем дай нужный контекст: о чём ролик, какой фокус, зачем смотреть. Запрещено начинать с мета-описаний вида 'Ролик обсуждает...', 'Автор рассказывает о...', 'В видео говорится, что...', 'Видео посвящено...'. Сразу содержательный тезис.",
  "key_points": ["[ПИШИ НА РУССКОМ] Краткий самостоятельный тезис для Telegram. Верни столько тезисов, сколько нужно для полного покрытия ключевых идей, без воды и повторов."],
  "chapters": [
    {{
      "title": "[ПИШИ НА РУССКОМ] Короткий содержательный заголовок ключевого тезиса (не таймкод, не 'Часть 1', не 'Введение')",
      "notes": "[ПИШИ НА РУССКОМ] Полное раскрытие тезиса. Включи саму идею, аргумент или обоснование автора, конкретные примеры, цифры, имена, цитаты или кейсы из ролика, а также нюансы, ограничения, контраргументы и практические выводы, если они есть. Количество предложений определи по содержанию. Пиши связным абзацем, не списком."
    }}
  ],
  "tags": {{
    "topic": "[ОДИН ТЕГ НА РУССКОМ] Главная тема ролика — одно слово или короткое словосочетание через _, без # и пробелов. Максимально точно отражает суть. Примеры: \\"экономика\\", \\"санкции\\", \\"выборы\\", \\"война\\", \\"медиа\\", \\"технологии\\", \\"международные_отношения\\", \\"внутренняя_политика\\".{topic_hint}",
    "speakers": ["[ДО 3 ФАМИЛИЙ ГОСТЕЙ] Кто ОТВЕЧАЕТ на вопросы / даёт мнение / приглашён в качестве эксперта. НЕ включай ведущего, интервьюера, автора канала. Если ролик — монолог одного автора без приглашённых гостей, верни []. Только фамилия с заглавной буквы (например \\"Гуриев\\", \\"Шульман\\"), без имени и отчества.{speaker_hint}"],
    "hosts": ["[ДО 5 ФАМИЛИЙ ВЕДУЩИХ] Кто ВЕДЁТ программу / задаёт вопросы / автор ролика. Может быть один (монолог автора), несколько (соведущие, утреннее шоу) или ноль (если ведущий неизвестен из транскрипции). НЕ путай с гостями. Только фамилия с заглавной буквы.{host_hint}"],
    "format": "[ОДИН ИЗ] интервью, расследование, разбор, новости, дискуссия. Выбирай ровно один."
  }}
}}
...
ВЕСЬ ТЕКСТ ОТВЕТА — НА РУССКОМ ЯЗЫКЕ. Если в частичных конспектах что-то осталось
по-английски, переводи на русский. Никакого смешанного "англо-русского" текста.
...
{{
  ...
  "chapters": [
    {{
      "title": "[ПИШИ НА РУССКОМ] Короткий содержательный заголовок ключевого тезиса (не таймкод, не 'Фрагмент 1', не 'Введение')",
      "notes": "[ПИШИ НА РУССКОМ] Полное раскрытие тезиса. Включи саму идею, аргумент или обоснование автора, конкретные примеры, цифры, имена, цитаты или кейсы из ролика, а также нюансы, ограничения, контраргументы и практические выводы, если они есть. Количество предложений определи по содержанию. Пиши связным абзацем, не списком."
    }}
  ],
  "tags": {{
    "topic": "[ОДИН ТЕГ НА РУССКОМ] Главная тема ролика — одно слово или короткое словосочетание через _, без # и пробелов. Максимально точно отражает суть.{topic_hint}",
    "speakers": ["[ДО 3 ФАМИЛИЙ ГОСТЕЙ] Кто отвечает / выступает приглашённым экспертом. НЕ включай ведущего/интервьюера/автора канала. Если ролик — монолог одного автора, верни []. Только фамилия с заглавной.{speaker_hint}"],
    "hosts": ["[ДО 5 ФАМИЛИЙ ВЕДУЩИХ] Кто ведёт программу / задаёт вопросы / автор ролика. Может быть один, несколько (соведущие) или 0 (если из конспекта неясно). НЕ путай с гостями. Только фамилия с заглавной.{host_hint}"],
...
Ниже материал по YouTube-ролику. Сделай компактное финальное summary.
ЯЗЫК ОТВЕТА — РУССКИЙ. Если материал на английском — переводи на русский.
...
Схема:
{{
  "overview": "[НА РУССКОМ] Главная идея ролика и короткий контекст.",
  "key_points": ["[НА РУССКОМ] Краткий самостоятельный тезис. Столько пунктов, сколько нужно для полноты."],
  "chapters": [
    {{
      "title": "[НА РУССКОМ] Содержательный заголовок тезиса",
      "notes": "[НА РУССКОМ] Раскрытие тезиса с аргументами, примерами, нюансами и выводами. Длину определи по содержанию."
    }}
  ]
}}
