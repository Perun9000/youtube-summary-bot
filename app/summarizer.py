...
Схема:
{{
  "overview": "Executive summary ролика. Начни с ГЛАВНОЙ МЫСЛИ или ключевого вывода одной чёткой формулировкой по сути. Затем — необходимый контекст: о чём ролик, какой фокус, кому и зачем это релевантно. Объём: 3–5 предложений, компактно и содержательно. Разбей текст на 2–4 коротких абзаца, разделённых пустой строкой внутри строки JSON (\\n\\n); первый абзац — главная мысль. Запрещено начинать с мета-фраз 'Ролик обсуждает…', 'Автор рассказывает о…', 'В видео говорится, что…', 'Видео посвящено…'. Сразу содержательный тезис.",
  "chapters": [
    {{
...
Схема:
{{
  "overview": "Executive summary ролика. Начни с ГЛАВНОЙ МЫСЛИ или ключевого вывода одной чёткой формулировкой по сути. Затем — необходимый контекст: о чём ролик, какой фокус, кому и зачем это релевантно. Объём: 3–5 предложений, компактно и содержательно. Разбей текст на 2–4 коротких абзаца, разделённых пустой строкой внутри строки JSON (\\n\\n); первый абзац — главная мысль. Запрещено начинать с мета-фраз 'Ролик обсуждает…', 'Автор рассказывает о…', 'В видео говорится, что…', 'Видео посвящено…'.",
  "chapters": [
    {{
...
Схема:
{{
  "overview": "Executive summary ролика — главная мысль + короткий контекст, 3–5 предложений. Разбей текст на 2–4 коротких абзаца, разделённых пустой строкой внутри строки JSON (\\n\\n); первый абзац — главная мысль.",
  "chapters": [
    {{
