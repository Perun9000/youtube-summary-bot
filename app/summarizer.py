...
{{
  ...
  "tags": {{
    ...
    "speakers": ["[ДО 3 ФАМИЛИЙ] Только фамилии гостей-экспертов с заглавной буквы (например \\"Гуриев\\", \\"Шульман\\"). НЕ включай ведущего/интервьюера/автора канала. Если ролик — монолог одного автора без приглашённых гостей, верни []. Только фамилии (без имени, без отчества).{speaker_hint}"],
...
{{
  ...
  "tags": {{
    ...
    "speakers": ["[ДО 3 ФАМИЛИЙ] Только фамилии гостей-экспертов с заглавной буквы. НЕ включай ведущего/интервьюера/автора канала. Если ролик — монолог одного автора, верни [].{speaker_hint}"],
...
class Summarizer:
    ...
    async def summarize(
        ...
        logger.info(
            ...
            len(chunks),
            bool(context_hint),
            bool(topic_hint or speaker_hint),
        )
...
def _parse_tags_from_response(raw_tags) -> SummaryTags:
    ...
    LLM возвращает ``{"topic": "...", "speakers": [...], "format": "..."}``.
    ...
    raw_speakers = raw_tags.get("speakers") or []
    speakers: list[str] = []
