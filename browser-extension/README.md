...
Никаких настроек, popup'ов и фоновых процессов — один `content_script`
на ~120 строк и немного CSS. Бот-handle захардкожен (`YouTube_Sum_mary_bot`),
менять — в `content.js`, константа `BOT_HANDLE`.
